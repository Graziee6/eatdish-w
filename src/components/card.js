...
function card({
  ...
  return (
    <div className="bg-white p-4 w-1/2 rounded-2xl mr-4">
      {/* top div */}
      <div className="grid grid-cols-2 gap-1">
        <img src={image} alt={altText} />
        <div>
          <p className="text-indigo-950 text-sm font-semibold">{name}</p>
      ...
      {/* bottom div */}
      <div className="grid grid-flow-col-dense grid-cols-2 gap-0.5">
        {/* play */}
        <div className="rounded-full bg-amber-500 p-2 grid grid-cols-5">
          <div className="rounded-full bg-white p-1 align-middle justify-center col-span-1">
            <BsPlayFill size={18} className="text-amber-500" />
          </div>
          <p className="capitalize font-light text-sm text-white col-span-4 leading-relaxed">
            Watch tutorial
          </p>
        </div>

        {/* time */}
        <div className="justify-center align-middle grid grid-cols-4 text-stone-500">
